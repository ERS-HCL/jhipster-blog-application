    ...
    return (
      <div>
        <h2 id="department-my-suffix-heading">
          <Translate contentKey="jhipsterBlogApp.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipsterBlogApp.department.home.createLabel">Create new Department</Translate>
          </Link>
        </h2>
