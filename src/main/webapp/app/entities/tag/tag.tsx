...
export class Tag extends React.Component<ITagProps, ITagState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="tag-heading">
          <Translate contentKey="jhipsterBlogApp.tag.home.title">Tags</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipsterBlogApp.tag.home.createLabel">Create new Tag</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="jhipsterBlogApp.tag.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
